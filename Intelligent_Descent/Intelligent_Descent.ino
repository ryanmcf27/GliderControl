/*
  ...
  This descent code makes decisions on when to transistion between flight states based on sensor data.
  We did not get the opportunity to test and fully complete this code in the 2024-2025 season, as we had to
  transistion to a timed descent due to delays in the X-1's manufacturing and limited manpower for the associated
  tasks.
