/*
  ...
  This program is for a timed descent which does not log sensor data as it flies. This was created to have
  a reliable flight control program in case of sensor failure at competition and needing to go for a barebones approach.
...
/* Constants and Pins */
static const int RXPin = 0, TXPin = 1, ServoPin = 10, LEDPin = 5, LimitPin = 8;
